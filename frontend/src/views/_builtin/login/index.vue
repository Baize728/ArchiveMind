    ...
    <NCard :bordered="false" class="relative z-4 w-auto card-wrapper">
      <div class="w-400px lt-sm:w-300px">
        <header class="flex flex-col items-center gap-2">
          ...
          <SystemLogo class="w-120px h-120px lt-sm:w-80px lt-sm:h-80px" />
          <h3 class="text-28px text-primary font-500 lt-sm:text-22px" style="font-family: 'Dancing Script', cursive;">{{ $t('system.title') }}</h3>
        </header>
        <main class="pt-24px">
